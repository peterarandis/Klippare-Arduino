...
void ultra_ping() {
       ...
       //-------
       if (distance <10)                                                           lyfcoStatus = "Charging";                            // 6-8 cm normalt
       if (distance >9 && distance <22)                                            lyfcoStatus = "Standby";                             // 11-13 cm normalt
       if (distance >=22 && lyfcoStatus != "Running" && lyfcoStatus != "Stuck" )  {lyfcoStatus = "Running";  lyfcoRunTime = millis();}  // 25+ cm, sätt starttid
