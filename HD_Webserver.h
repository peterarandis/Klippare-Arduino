...
void pageRoot() {
     ...
     <table width=100% cellspacing=0 cellpadding=2 border = 0>\
        <tr bgcolor=#133670><td>\
          <table width=100% cellspacing=0 cellpadding=1 border=0>\
             <tr bgcolor=#133670>\
                <td width=50%><font color='white'><b>&nbsp;Sens-ID</td>\
                <td width=25%><font color='white'><b>Sens-Payload</td>\
                <td widtd=25%><font color='white'><b>Sens-Status</td>\
            </tr>";
  ...
  byte x;
   ...
   //buff += "<tr bgcolor=#888888><td>" + Device[i].Name + " (DeviceID:" + String(i) + ", MQTT-Ident:" +  Device[i].MQTT_Ident + ")</td><td>&nbsp</td><td>&nbsp</td></tr>";
    ...
    buff += "<tr bgcolor=#FFFFFF><td>" + String(distance)  + "</td><td>"+String(dist_now)+"</td><td>" + lyfcoStatus + "</td></tr>";
